...
export const getBeatsArray = (id: string, startOffset: number): number[] => {
  ...
  } else if (id === "jbX4FSCgZL3hz90CmnRd") {
    return [
      1.16, 2.32, 2.9, 3.46, 4.02, 4.58, 5.14, 5.7, 6.26, 6.82, 7.38, 7.94, 8.5,
      9.06, 9.62, 10.18, 10.74, 11.3, 11.86, 12.42, 12.98, 13.54, 14.1, 14.66,
      15.22, 15.78, 16.34, 16.92, 17.46, 18.02, 18.6, 19.16, 19.72, 20.28,
      20.82, 21.4, 21.96, 22.52, 23.08, 23.64, 24.2, 24.76, 25.32, 25.88, 26.44,
      27.0, 27.56, 28.12, 28.68, 29.24, 29.82, 30.38, 30.92, 31.5, 32.04, 32.62,
      33.18, 33.72, 34.28, 34.86, 35.42, 35.98, 36.54, 37.1, 37.66, 38.22,
      38.78, 39.34, 39.9, 40.46, 41.02, 41.58, 42.14, 42.7, 43.26, 43.82, 44.38,
      44.94, 45.52, 46.06, 46.64, 47.18, 47.74, 48.32, 48.88, 49.42, 50.0,
      50.56, 51.12, 51.66, 52.24, 52.8, 53.36, 53.92, 54.48, 55.04, 55.6, 56.16,
      56.72, 57.28, 57.84, 58.4, 58.96, 59.54, 60.1, 60.64, 61.22, 61.78, 62.32,
      62.88, 63.46, 64.02, 64.58, 65.14, 65.7, 66.26, 66.82, 67.38, 67.94, 68.5,
      69.06, 69.62, 70.18, 70.74, 71.3, 71.86, 72.42, 72.98, 73.56, 74.1, 74.66,
      75.24, 75.78, 76.34, 76.92, 77.46, 78.04, 78.58, 79.16, 79.72, 80.28,
      80.84, 81.4, 81.96, 82.52, 83.08, 83.64, 84.2, 84.76, 85.32, 85.88, 86.44,
      87.0, 87.56, 88.12, 88.68, 89.24, 89.8, 90.36, 90.92, 91.5, 92.06, 92.6,
      93.18, 93.72, 94.3, 94.86, 95.42, 95.98, 96.54, 97.1, 97.66, 98.22, 98.78,
      99.34, 99.9, 100.46, 101.02, 101.58, 102.14, 102.7, 103.26, 103.82,
      104.38, 104.94, 105.5, 106.08, 106.64, 107.2, 107.76, 108.32, 108.88,
      109.44, 110.0, 110.56, 111.12, 111.68, 112.24, 112.8, 113.36, 113.92,
      114.48, 115.04, 115.6, 116.16, 116.72, 117.28, 117.84, 118.4, 118.96,
      119.52, 120.08, 120.64, 121.2, 121.76, 122.32, 122.9, 123.44, 124.02,
      124.58, 125.14, 125.7, 126.26, 126.82, 127.38, 127.94, 128.52, 129.08,
      129.64, 130.2, 130.78, 131.32, 131.88, 133.06,
    ];
  } else {
